  ...
  Widget _indicator(bool isActive) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isActive ? theme.colorScheme.primary : theme.colorScheme.primary.withAlpha(120),
...
class _SingleHotelPage extends StatelessWidget {
  ...
  const _SingleHotelPage({Key? key, required this.image, required this.name}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FxSpacing.height(16),
                  FxText.bodyLarge('St. James\'s Club Morgan Bay', fontWeight: 500),
                  FxText.titleSmall('Hotel Nacional de Cuba', fontWeight: 500),
                  FxText.titleSmall('Memories Trinidad Del Mar', fontWeight: 500),
                  FxSpacing.height(24),
                  Center(
                    child: FxButton(
                        elevation: 0,
                        ...
                        child: FxText.bodyMedium(("Book at $name"),
                            color: themeData.colorScheme.onSecondary, letterSpacing: 0.2)),
                  ),
                ],
              ),
            )
