...
import 'package:seller/views/login_signup/business_information_register_screen.dart';
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => BusinessInformationRegisterScreen()));
                        },
                        child: Text("info"),
                      ),
                    ],
