...
import 'package:seller/views/product_manager/add_product/step_two_screen.dart';
            ...
            children: [
              ...
              buildDropdownButton(
                ...
                disabledHint: selectedSubCategory == null
                    ...
                    : (childCategories[selectedSubCategory!] ?? []).isEmpty
                        ? const Text("No child-categories available")
                        : const Text("Select a Sub-Category"),
