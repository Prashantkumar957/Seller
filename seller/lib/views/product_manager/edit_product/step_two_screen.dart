...
import 'package:seller/views/product_manager/edit_product/step_three_screen.dart';
...
class _StepTwoScreenState extends State<StepTwoScreen> {
  ...
  void initState() {
    ...
    _selectedItem = widget.product['item_type'];

    productTitleController.text = widget.product['product_title'];
    brandNameController.text = widget.product['brand_name'];
    skuController.text = widget.product['SUK'];
    countryOfOriginController.text = widget.product['origin'];
    manufacturerNameController.text = widget.product['manufacturer'];

    _selectedTags = widget.product['tags'].toString().split(",");
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildSummernoteEditor(
                            ...
                            defaultValue: widget.product['description'],
                                  ...
                                  if (_formKey.currentState?.validate() ??
                                    ...
                                    if (description == null  ||  description.length < 20) {
                                      CoolAlert.show(
                                          ...
                                          title: "Error",
                                          text:
                                          "Description is too short. It should be at least 20 characters long.");
                                      return;
                                    }
                                    ...
                                    for (int i = 0; i < _items.length; i++) {
                                      String x = _items[i];
                                      if (_selectedItem != null  &&  x.toLowerCase() == _selectedItem!.toLowerCase()) {
                                        idx = i;
                                        break;
                                      }
                                    }
